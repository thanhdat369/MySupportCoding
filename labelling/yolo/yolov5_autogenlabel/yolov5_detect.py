...
# name = get_list_label('classes.txt')
...
BASE_FOLDER = 'D:/FPT_Capstone/Capstone/03_Data/SignDetect2/new_labels/'
IMAGE_FOLDER = BASE_FOLDER + "images/"
LABEL_FOLDER = BASE_FOLDER + "labels/"
all_image_name = os.listdir(IMAGE_FOLDER)
size = (640,480)
for img_name in all_image_name:
    ...
    save_label_path = LABEL_FOLDER + img_name.split('.')[0]+".txt"
    print(save_label_path)
    write_labels_file(save_label_path,list_labels_content)
